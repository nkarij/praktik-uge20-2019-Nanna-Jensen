...
// write ONE education to dom

testButtonWriteToDOM.addEventListener('click', function(event){
    event.preventDefault();
    let writeThisEducationToDOM = education;
    // metoden modtager 2 argumenter: education-object + css-selector;
    institution.writeEducationToDOM(writeThisEducationToDOM, "#list-container");
});
